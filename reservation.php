...
<html>
    <head>
        ...
        <title> Agrotourism Dau | Reservation Form</title>
        ...
        <section class = "banner">
            <div class = "card-container">
                ...
                <div class = "card-content">
                    <a href="index.php" style="position:relative;top:10px;right:15px;float:right;z-index:99;text-decoration:none;">x</a>

                    <h3>Reservation</h3>
                    <form>
                        <div class = "form-row">
                            <input type = "date" placeholder="Year-Month-Date" name="tanggal" required>
                        ...
                        <div class = "form-row">
                            <input type = "number" placeholder="Persons" min = "1" name="number" required>
